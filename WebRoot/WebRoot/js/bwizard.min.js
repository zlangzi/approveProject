...
(function(k, h, j) {
    ...
    k.removeCookie = function(a, b) {
        if (k.cookie(a) !== null) { k.cookie(a, null, b);
            return true; }
        return false; };
})(jQuery, document);
/*!
...
(function(f, h) {
    ...
    f.cleanData = function(d) {
        for (var c = 0, b;
            (b = d[c]) != null; c++) {
            try { f(b).triggerHandler("remove"); } catch (a) {} }
        j(d); };
    f.widget = function(o, d, p) {
        ...
        if (b) { f.each(b._childConstructors, function(l, k) {
                var m = k.prototype;
                f.widget(m.namespace + "." + m.widgetName, e, k._proto); });
            delete b._childConstructors; } else {
        ...
        f.fn[b] = function(e) {
            ...
            if (n) {
                this.each(function() {
                    ...
                    var k = f.data(this, a);
                    if (k) { k.option(e || {})._init(); } else { new c(e, this); } }); }
            return d;
        };
    };
    f.Widget = function() {};
    ...
    f.Widget.prototype = {
        ...
        option: function(c, b) {
            ...
            if (typeof c === "string") {
                ...
                if (a.length) {
                    ...
                    for (e = 0; e < a.length - 1; e++) { d[a[e]] = d[a[e]] || {};
                        d = d[a[e]]; }
                    c = a.pop();
                    if (b === h) {
        ...
        _on: function(a, b) {
            ...
            f.each(b, function(r, d) {
                ...
                if (typeof d !== "string") { o.guid = d.guid = d.guid || o.guid || f.guid++; }
                var e = r.match(/^(\w+)\s*(.*)$/),
    ...
    f.each({ show: "fadeIn", hide: "fadeOut" }, function(a, b) {
        f.Widget.prototype["_" + a] = function(e, m, c) {
            ...
            if (d && f.effects && (f.effects.effect[n] || f.uiBackCompat !== false && f.effects[n])) {
                ...
                if (n !== a && e[n]) { e[n](m.duration, m.easing, c); } else { e.queue(function(k) { f(this)[a]();
                        if (c) { c.call(e[0]); }
                        k(); }); } }
        };
    });
...
(function(a, b) {
    a.widget("bootstrap.bwizard", {
        options: { clickableSteps: true, autoPlay: false, delay: 3000, loop: false, hideOption: { fade: true }, showOption: { fade: true, duration: 400 }, ajaxOptions: null, cache: false, cookie: null, stepHeaderTemplate: "", panelTemplate: "", spinner: "", backBtnText: "&larr; 上一个", nextBtnText: "下一个 &rarr;", add: null, remove: null, activeIndexChanged: null, show: null, load: null, validating: null },
        _defaults: { stepHeaderTemplate: "<li>#{title}</li>", panelTemplate: "<div></div>", spinner: "<em>Loading&#8230;</em>" },
        _create: function() {
            var c = this;
            c._pageLize(true);
        },
        _init: function() {
            var d = this.options,
                c = d.disabled;
            if (d.disabledState) { this.disable();
                d.disabled = c; } else {
                if (d.autoPlay) { this.play(); } } },
        ...
        _normalizeBlindOption: function(d) {
            if (d.blind === b) { d.blind = false; }
            if (d.fade === b) { d.fade = false; }
            if (d.duration === b) { d.duration = 200; }
        ...
        _pageLize: function(f) {
            ...
            if (this.list && c === 0) { this.list = null; }
            if (this.list) {
                if (this.list.get(0).tagName.toLowerCase() === "ol") { g = true; }
                ...
                this.lis.each(function(j) {
                    ...
                    a(this).prepend('<span class="label">' + "</span>");
            ...
            if (f) {
                ...
                if (e.activeIndex === b) {
                    if (typeof e.activeIndex !== "number" && e.cookie) { e.activeIndex = parseInt(d._cookie(), 10); }
                    ...
                    if (e.activeIndex === null) { e.activeIndex = -1; } }
            ...
            if (e.cache === false) { this.panels.removeData("cache.bwizard"); }
            if (e.showOption === b || e.showOption === null) {
                e.showOption = {};
            }
            this._normalizeBlindOption(e.showOption);
            if (e.hideOption === b || e.hideOption === null) { e.hideOption = {}; }
        ...
        _resetStyle: function(c) { c.css({ display: "" });
            if (!a.support.opacity) { c[0].style.removeAttribute("filter"); } },
        destroy: function() {
            var c = this.options;
            this.abort();
            this.stop();
            ...
            this.panels.each(function() {
                ...
                a.each(["load", "cache"], function(e, f) { d.removeData(f + ".bwizard"); });
        ...
        add: function(d, g) {
            ...
            } else { e.insertBefore(this.panels[d]); }
        ...
        remove: function(c) {
            ...
            if (c < e.activeIndex) { e.activeIndex--; }
            this._pageLize();
        ...
        _showPanel: function(f) {
            ...
            if ((g.showOption.blind || g.showOption.fade) && g.showOption.duration > 0) {
                ...
                if (g.showOption.blind) { d.height = "toggle"; }
                if (g.showOption.fade) { d.opacity = "toggle"; }
        ...
        show: function(f) {
            ...
            h.activeIndex = f;
            this.abort();
            if (h.cookie) { this._cookie(h.activeIndex, h.cookie); }
            this._refreshStep();
            if (g.length) {
                if (c.length) {
                    this.element.queue("bwizard", function() {
                ...
                this.element.queue("bwizard", function() { d._showPanel(g); });
                this.load(f);
            } else {
        ...
        next: function() {
            ...
            if (d.disabled) {
                return false; }
            if (d.loop) { c = c % this.panels.length; }
        ...
        back: function() {
            ...
            if (d.disabled) {
                return false; }
            if (d.loop) { c = c < 0 ? this.panels.length - 1 : c; }
            if (c >= 0) {
                this.show(c);
                return true;
            }
        ...
        load: function(e) {
            ...
            this.xhr = a.ajax(a.extend({}, h.ajaxOptions, {
                ...
                success: function(j, i) {
                    a(f).html(j);
                    if (h.cache) { a.data(f, "cache.bwizard", true); }
                ...
                error: function(k, i) { c._trigger("load", null, c._ui(c.panels[e]));
                    try {
                        if (h.ajaxOptions && h.ajaxOptions.error) { h.ajaxOptions.error(k, i, e, f); } } catch (j) {} }
            }));
